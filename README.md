...
#### Changes:
Added opening data from [ChessGraph](https://github.com/Destaq/chess-graph), as generated by the daughter project [eco.json.tooling](https://github.com/JeffML/eco.json.tooling).
