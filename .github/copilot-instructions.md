...
- **scores.json**: Position evaluation scores in centipawns (generated by eco.json.tooling)
...
- Published files for download: fromToPositionIndexed.json (3.7 MB), scores.json (1.2 MB)
